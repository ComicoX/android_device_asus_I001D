...
import com.havoc.settings.rogparts.doze.DozeSettingsActivity;

public class rogparts extends PreferenceFragment implements
        Preference.OnPreferenceChangeListener {

    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        setPreferencesFromResource(R.xml.rogparts, rootKey);
