...
import com.havoc.settings.rogparts.R;
    ...
    public static class MainSettingsFragment extends PreferenceFragment {
        ...
        private Preference.OnPreferenceChangeListener mHapticPrefListener =
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                if (KEY_HAPTIC_FEEDBACK.equals(key)) {
                    ...
                    rogparts.putInt(getContext(), KEY_HAPTIC_FEEDBACK, value ? 1 : 0);
                    return true;
                }
                return false;
            }
        ...
        private class TouchscreenGesturePreference extends ListPreference {
            ...
            public TouchscreenGesturePreference(final Context context,
                ...
                setTitle(rogparts.getLocalizedString(
        ...
        public void onResume() {
            ...
            mHapticFeedback.setChecked(
                    rogparts.getInt(getContext(), KEY_HAPTIC_FEEDBACK, 1) != 0);
        }
